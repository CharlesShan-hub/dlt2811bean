package com.ysh.dlt2811bean.scl.model.ied;
...
public class SclServer {
    ...
    public int setDataValue(String ref, String value, SclDataTypeTemplates templates) {
        return com.ysh.dlt2811bean.scl.util.SclSetSetDataValueResolver.setDataValue(this, ref, value, templates);
    }

    public SclDataDefinitionEntry resolveDataDefinition(String ref, String fc, SclDataTypeTemplates templates) {
        return com.ysh.dlt2811bean.scl.util.SclDataDefinitionResolver.resolveDataDefinition(this, ref, fc, templates);
    }

    public SclFCDA parseRefToFcda(String ref) {
        return com.ysh.dlt2811bean.scl.util.SclDataSetResolver.parseRefToFcda(this, ref);
    }
}
