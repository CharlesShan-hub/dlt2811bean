...
import com.ysh.dlt2811bean.datatypes.numeric.CmsInt64U;
...
class CmsInt64UTest {
    ...
    void positive() throws Exception {
        ...
        CmsInt64U.write(pos, new BigInteger("12345678901234567890"));

        PerInputStream pis = new PerInputStream(pos.toByteArray());
        assertEquals(new BigInteger("12345678901234567890"), CmsInt64U.read(pis).get());
    }
    ...
    void min() throws Exception {
        PerOutputStream pos = new PerOutputStream();
        CmsInt64U.write(pos, CmsInt64U.MIN);

        PerInputStream pis = new PerInputStream(pos.toByteArray());
        assertEquals(CmsInt64U.MIN, CmsInt64U.read(pis).get());
    }
    ...
    void max() throws Exception {
        PerOutputStream pos = new PerOutputStream();
        CmsInt64U.write(pos, CmsInt64U.MAX);

        PerInputStream pis = new PerInputStream(pos.toByteArray());
        assertEquals(CmsInt64U.MAX, CmsInt64U.read(pis).get());
    }
    ...
    void zero() throws Exception {
        PerOutputStream pos = new PerOutputStream();
        CmsInt64U.write(pos, BigInteger.ZERO);
    ...
    void belowMin() {
        PerOutputStream pos = new PerOutputStream();
        assertThrows(IllegalArgumentException.class, () -> CmsInt64U.write(pos, new BigInteger("-1")));
    }
    ...
    void aboveMax() {
        PerOutputStream pos = new PerOutputStream();
        assertThrows(IllegalArgumentException.class, () -> CmsInt64U.write(pos, new BigInteger("18446744073709551616")));
    }

    @Test
    @DisplayName("constructor validates range")
    void constructorValidatesRange() {
        assertDoesNotThrow(() -> new CmsInt64U(BigInteger.ZERO));
        assertDoesNotThrow(() -> new CmsInt64U(new BigInteger("9223372036854775807")));
        assertDoesNotThrow(() -> new CmsInt64U(CmsInt64U.MAX));

        assertThrows(IllegalArgumentException.class, () -> new CmsInt64U(new BigInteger("-1")));
        assertThrows(IllegalArgumentException.class, () -> new CmsInt64U(new BigInteger("18446744073709551616")));
    }
    ...
    void instanceRoundTrip() throws Exception {
        ...
        CmsInt64U val2 = CmsInt64U.read(new PerInputStream(pos.toByteArray()));
    ...
    void chainUsage() throws Exception {
        ...
        CmsInt64U decoded = CmsInt64U.read(new PerInputStream(pos.toByteArray()));
        assertEquals(new BigInteger("12345678901234567890"), decoded.get());
    }

    @Test
    @DisplayName("static write with CmsInt64U object")
