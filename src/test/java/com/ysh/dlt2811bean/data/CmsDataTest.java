...
import com.ysh.dlt2811bean.data.code.CmsCheck;
import com.ysh.dlt2811bean.data.code.CmsQuality;
import com.ysh.dlt2811bean.data.code.CmsTimeQuality;
import com.ysh.dlt2811bean.data.collection.CmsArray;
import com.ysh.dlt2811bean.data.collection.CmsStructure;
import com.ysh.dlt2811bean.data.compound.CmsBinaryTime;
import com.ysh.dlt2811bean.data.compound.CmsUtcTime;
import com.ysh.dlt2811bean.data.enumerated.CmsDbpos;
import com.ysh.dlt2811bean.data.enumerated.CmsServiceError;
import com.ysh.dlt2811bean.data.enumerated.CmsTcmd;
import com.ysh.dlt2811bean.data.numeric.*;
import com.ysh.dlt2811bean.data.string.CmsBitString;
import com.ysh.dlt2811bean.data.string.CmsOctetString;
import com.ysh.dlt2811bean.data.string.CmsUtf8String;
...
//
    ...
    void dbposEntity() throws Exception {
        ...
        CmsData<CmsDbpos> decoded = new CmsData<CmsDbpos>()
                .set(new CmsDbpos())
                .decode(new PerInputStream(pos.toByteArray()));
        assertTrue(decoded.get().is(CmsDbpos.ON));
    }
    ...
    void dbposStatic() throws Exception {
        ...
        CmsData.read(new PerInputStream(pos.toByteArray()), template);
        assertTrue(template.is(CmsDbpos.ON));
    }
    ...
    void tcmdEntity() throws Exception {
        ...
        CmsData<CmsTcmd> decoded = new CmsData<CmsTcmd>()
                .set(new CmsTcmd())
                .decode(new PerInputStream(pos.toByteArray()));
        assertTrue(decoded.get().is(CmsTcmd.HIGHER));
    }
    ...
    void tcmdStatic() throws Exception {
        ...
        CmsData.read(new PerInputStream(pos.toByteArray()), template);
        assertTrue(template.is(CmsTcmd.HIGHER));
    }
