...
class CmsGetDataSetDirectoryTest {
    ...
    void requestRoundTrip() throws Exception {
        ...
        CmsGetDataSetDirectory result = (CmsGetDataSetDirectory) decoded.getAsdu();
    ...
    void positiveResponseRoundTrip() throws Exception {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(MessageType.RESPONSE_POSITIVE)
            .reqId(3);
    ...
    @Test
    @DisplayName("RESPONSE_POSITIVE: empty memberData list")
    ...
    void negativeResponseRoundTrip() throws Exception {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(MessageType.RESPONSE_NEGATIVE)
    ...
    void requestRoundTripAsduOnly() throws Exception {
        CmsGetDataSetDirectory service = new CmsGetDataSetDirectory(MessageType.REQUEST)
            .datasetReference("IED1.AP1.LD1.LN1.DS1")
            .reqId(10);

        PerOutputStream pos = new PerOutputStream();
        CmsGetDataSetDirectory.write(pos, service);

        CmsGetDataSetDirectory result = CmsGetDataSetDirectory.read(new PerInputStream(pos.toByteArray()), MessageType.REQUEST);
    ...
    void copy() {
        CmsGetDataSetDirectory original = new CmsGetDataSetDirectory(MessageType.REQUEST)
            .datasetReference("IED1.AP1.LD1.LN1.DS1")
            .referenceAfter("IED1.AP1.LD1.LN1.DO1.DA1")
            .reqId(10);

        CmsGetDataSetDirectory copy = original.copy();
    ...
    void fromFlagsRequest() {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(false, false);
    ...
    void fromFlagsPositive() {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(true, false);
    ...
    void fromFlagsNegative() {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(true, true);
        assertEquals(MessageType.RESPONSE_NEGATIVE, asdu.messageType());
    }

    @Test
    @DisplayName("getServiceCode returns GET_DATA_SET_DIRECTORY")
    void serviceCode() {
        CmsGetDataSetDirectory asdu = new CmsGetDataSetDirectory(MessageType.REQUEST);
        assertEquals(ServiceName.GET_DATA_SET_DIRECTORY, asdu.getServiceName());
    }
    ...
    void toStringRequest() {
        ...
        assertTrue(str.startsWith("(CmsGetDataSetDirectory) {"));
