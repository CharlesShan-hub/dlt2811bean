...
class CmsTimeActivatedOperateTest {
    @Test
    void requestRoundTrip() throws Exception {
        ...
        CmsTimeActivatedOperate result = (CmsTimeActivatedOperate) decoded.getAsdu();
    ...
    @Test
    void serviceCode() {
        assertEquals(ServiceName.TIME_ACTIVATED_OPERATE, new CmsTimeActivatedOperate(MessageType.REQUEST).getServiceName());
    }
}
