...
public class CmsGetLogStatusValuesError extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeGetLogStatusValuesError(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeGetLogStatusValuesError(nativePtr, data); read(); }
}