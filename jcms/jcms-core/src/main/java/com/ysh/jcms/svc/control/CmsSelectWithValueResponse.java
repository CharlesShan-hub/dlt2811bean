...
/**
 * SelectWithValue-ResponsePDU ::= SEQUENCE { reqId Int16U, reference [0]
 ...
 * IMPLICIT Check } — 8.11.2
 */
public class CmsSelectWithValueResponse extends CmsTypeOld {
    ...
    public CmsSelectWithValueResponse() {
        super(Codec.SELECT_WITH_VALUE_RESPONSE);
    ...
    public CmsSelectWithValueResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsSelectWithValueResponse operTmPresent(boolean v) {
    ...
    public List<? extends CmsTypeOld> children() {
        return Arrays.asList(reqId, reference, ctlVal, operTmPresent, operTm, origin, ctlNum, t, test, check);
    }
}
