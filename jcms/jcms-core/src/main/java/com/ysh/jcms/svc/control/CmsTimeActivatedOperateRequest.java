...
/**
 * TimeActivatedOperate-RequestPDU ::= SEQUENCE { reqId Int16U, reference [0]
 ...
 */
public class CmsTimeActivatedOperateRequest extends CmsTypeOld {
    ...
    public CmsTimeActivatedOperateRequest() {
        super(Codec.TIME_ACTIVATED_OPERATE_REQUEST);
    ...
    public CmsTimeActivatedOperateRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
