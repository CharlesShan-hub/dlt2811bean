...
/**
 * SelectWithValue-RequestPDU ::= SEQUENCE { reqId Int16U, reference [0]
 ...
 */
public class CmsSelectWithValueRequest extends CmsTypeOld {
    ...
    public CmsSelectWithValueRequest() {
        super(Codec.SELECT_WITH_VALUE_REQUEST);
    ...
    public CmsSelectWithValueRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsSelectWithValueRequest operTmPresent(boolean v) {
