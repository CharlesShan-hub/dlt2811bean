...
public class CmsRpcMethodDef extends CmsSequence {
    ...
    @CmsField public CmsInt32U version;
    @CmsField public CmsInt32U timeout;
    @CmsField public CmsDataDefinition request;
    @CmsField public CmsDataDefinition response;

    public CmsRpcMethodDef() { super(new InnerAnonymousGetRpcMethodDefinitionResponsePDUReferenceMethod()); }
    ...
    public CmsRpcMethodDef request(CmsDataDefinition v) { this.request.value(v); return this; }
    public CmsRpcMethodDef response(CmsDataDefinition v) { this.response.value(v); return this; }
