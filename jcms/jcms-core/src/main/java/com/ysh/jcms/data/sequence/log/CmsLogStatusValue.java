...
public class CmsLogStatusValue extends CmsSequence {
    ...
    @CmsField public CmsBinaryTime oldEntrTm;
    @CmsField public CmsBinaryTime newEntrTm;
    @CmsField public CmsEntryId oldEntr;
    @CmsField public CmsEntryId newEntr;

    public CmsLogStatusValue() { super(new InnerAnonymousGetLogStatusValuesResponsePDULogValue()); }

    public CmsLogStatusValue oldEntrTm(CmsBinaryTime v) { this.oldEntrTm.value(v); return this; }
    public CmsLogStatusValue newEntrTm(CmsBinaryTime v) { this.newEntrTm.value(v); return this; }
