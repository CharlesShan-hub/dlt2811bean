...
public class CmsPhyComAddr extends CmsSequence {
    @CmsField public CmsOctetString addr;
    @CmsField public CmsInt8U priority;
    @CmsField public CmsInt16U vid;
    @CmsField public CmsInt16U appid;

    public CmsPhyComAddr() { super(new InnerPhyComAddr()); }
