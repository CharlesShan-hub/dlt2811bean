...
/**
 * Cancel-ResponsePDU ::= SEQUENCE { reqId Int16U, reference [0] IMPLICIT
 ...
 */
public class CmsCancelResponse extends CmsTypeOld {
    ...
    public CmsCancelResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsCancelResponse operTmPresent(boolean v) {
