 ...
 *
 * OPTIONAL fields (smpMod, dstAddress) use a CmsBoolean "present" flag before
 * the value.
 */
public class CmsMsvcb extends CmsType {
    ...
    public CmsMsvcb smpMod_present(boolean v) {
        this.smpMod_present.value(v);
        return this;
    }
    ...
    public CmsMsvcb dstAddress_present(boolean v) {
    ...
    public List<? extends CmsType> children() {
        return Arrays.asList(svEna, msvID, datSet, confRev, smpMod_present, smpMod, smpRate, optFlds, dstAddress_present, dstAddress);
    }
}
