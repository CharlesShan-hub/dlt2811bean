...
public class CmsGetFileDirectoryRequest extends CmsSequence {
    ...
    @CmsField public CmsString pathName;
    @CmsField(optional = true) public CmsUtcTime startTime;
    @CmsField(optional = true) public CmsUtcTime stopTime;
    @CmsField(optional = true) public CmsString fileAfter;
