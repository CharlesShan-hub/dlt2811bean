...
public class CmsSelectEditSgError extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeSelectEditSgError(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeSelectEditSgError(nativePtr, data); read(); }
}