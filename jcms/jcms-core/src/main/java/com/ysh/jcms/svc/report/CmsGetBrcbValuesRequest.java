...
public class CmsGetBrcbValuesRequest extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeGetBrcbValuesRequest(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeGetBrcbValuesRequest(nativePtr, data); read(); }
}