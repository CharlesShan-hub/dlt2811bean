...
/**
 * Check ::= BIT STRING (SIZE(2)) — 7.5.3 PER: align + 1 byte (2 bits)
 *
 * All-pointer container: [0] syncheck → CmsBoolean* [8] interlock_check →
 * CmsBoolean*
 */
public class CmsCheck extends CmsType {
    ...
    public CmsCheck syncheck(boolean v) {
        this.syncheck.value(v);
        return this;
    }
    public CmsCheck interlock_check(boolean v) {
        this.interlock_check.value(v);
        return this;
    }
