 ...
 * IMPLICIT BOOLEAN OPTIONAL, goID [2] IMPLICIT VisibleString129 OPTIONAL,
 * datSet [3] IMPLICIT ObjectReference OPTIONAL } — 8.9.5
 *
...
public class CmsSetGoCbEntry extends CmsType {
    ...
    public CmsSetGoCbEntry goEnaPresent(boolean v) {
        this.goEnaPresent.value(v);
        return this;
    }
    ...
    public CmsSetGoCbEntry goIdPresent(boolean v) {
        this.goIdPresent.value(v);
        return this;
    }
    public CmsSetGoCbEntry goId(byte[] v) {
        this.goIdPresent.value(v != null && v.length > 0);
        if (v != null)
            this.goId.value(v);
        return this;
    }
    public CmsSetGoCbEntry goId(String v) {
        this.goIdPresent.value(v != null);
        if (v != null)
            this.goId.value(v);
        return this;
    }
    public CmsSetGoCbEntry datSetPresent(boolean v) {
