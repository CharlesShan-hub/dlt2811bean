...
/**
 * GetRpcInterfaceDefinition-RequestPDU ::= SEQUENCE { reqId Int16U, interface
...
public class CmsGetRpcInterfaceDefinitionRequest extends CmsType {
    ...
    public CmsGetRpcInterfaceDefinitionRequest() {
        super(Codec.GET_RPC_INTERFACE_DEFINITION_REQUEST);
    ...
    public CmsGetRpcInterfaceDefinitionRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsGetRpcInterfaceDefinitionRequest refAfterPresent(boolean v) {
        this.refAfterPresent.value(v);
        return this;
    }
    public CmsGetRpcInterfaceDefinitionRequest refAfter(byte[] v) {
        this.refAfterPresent.value(v != null && v.length > 0);
        if (v != null)
            this.refAfter.value(v);
        return this;
    }
    public CmsGetRpcInterfaceDefinitionRequest refAfter(String v) {
