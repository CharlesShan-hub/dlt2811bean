...
/**
 * GetGoReference-ResponsePDU ::= SEQUENCE { reqId Int16U, gocbReference [0]
 * IMPLICIT ObjectReference, confRev [1] IMPLICIT INT32U, datSet [2] IMPLICIT
 * ObjectReference, memberData [3] IMPLICIT SEQUENCE OF GoRefFcEntry } — 8.9.2
 */
public class CmsGetGoReferenceResponse extends CmsTypeOld {
    ...
    public CmsGetGoReferenceResponse() {
        super(Codec.GET_GO_REFERENCE_RESPONSE);
    ...
    public CmsGetGoReferenceResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsGetGoReferenceResponse memberData(CmsArray<CmsGoRefFcEntry> v) {
        this.memberData = v;
        return this;
    }
