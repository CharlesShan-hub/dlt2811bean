...
/**
 * QueryLogAfter-RequestPDU ::= SEQUENCE { reqId Int16U, logReference [0]
 * IMPLICIT ObjectReference, startTime [1] IMPLICIT EntryTime OPTIONAL, entry
 * [2] IMPLICIT EntryID } — 8.8.5
 */
public class CmsQueryLogAfterRequest extends CmsTypeOld {
    ...
    public CmsQueryLogAfterRequest() {
        super(Codec.QUERY_LOG_AFTER_REQUEST);
    ...
    public CmsQueryLogAfterRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsQueryLogAfterRequest startTimePresent(boolean v) {
