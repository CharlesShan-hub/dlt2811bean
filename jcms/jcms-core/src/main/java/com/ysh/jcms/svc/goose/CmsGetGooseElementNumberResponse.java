...
/**
 * GetGOOSEElementNumber-ResponsePDU ::= SEQUENCE { reqId Int16U, gocbReference
 * [0] IMPLICIT ObjectReference, confRev [1] IMPLICIT INT32U, datSet [2]
...
public class CmsGetGooseElementNumberResponse extends CmsTypeOld {
    ...
    public CmsGetGooseElementNumberResponse() {
        super(Codec.GET_GOOSE_ELEMENT_NUMBER_RESPONSE);
    ...
    public CmsGetGooseElementNumberResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsGetGooseElementNumberResponse memberOffset(CmsArray<CmsInt16U> v) {
        this.memberOffset = v;
        return this;
    }
