 ...
 *
 * PER wire format is VisibleString(SIZE(2)) — 2 ASCII chars. Use
 * {@link #fromCode(String)} to lookup an FC value by its 2-char code (e.g. "ST"
 * → 0), or {@link #fromString(String)} for case-insensitive lookup.
 */
