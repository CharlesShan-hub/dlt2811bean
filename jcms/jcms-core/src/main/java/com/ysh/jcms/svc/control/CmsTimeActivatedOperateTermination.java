...
public class CmsTimeActivatedOperateTermination extends CmsType {
    ...
    public CmsTimeActivatedOperateTermination() { super(Codec.TIME_ACTIVATED_OPERATE_TERMINATION);
    ...
    public CmsTimeActivatedOperateTermination operTm(CmsUtcTime v) { this.operTm = v; return this; }
    ...
    public CmsTimeActivatedOperateTermination t(CmsUtcTime v) { this.t = v; return this; }
