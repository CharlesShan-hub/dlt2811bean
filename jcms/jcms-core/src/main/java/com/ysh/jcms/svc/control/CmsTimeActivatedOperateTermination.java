...
/**
 * TimeActivatedOperateTermination-RequestPDU ::= SEQUENCE { reqId Int16U,
 * reference [0] IMPLICIT ObjectReference, ctlVal [1] IMPLICIT Data, operTm [2]
 * IMPLICIT TimeStamp, origin [3] IMPLICIT Originator, ctlNum [4] IMPLICIT
 * INT8U, t [5] IMPLICIT TimeStamp, test [6] IMPLICIT BOOLEAN, check [7]
 * IMPLICIT Check, addCause [8] IMPLICIT AddCause OPTIONAL } — 8.11.7
 *
...
public class CmsTimeActivatedOperateTermination extends CmsType {
    ...
    public CmsTimeActivatedOperateTermination() {
        super(Codec.TIME_ACTIVATED_OPERATE_TERMINATION);
    ...
    public CmsTimeActivatedOperateTermination reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsTimeActivatedOperateTermination addCausePresent(boolean v) {
