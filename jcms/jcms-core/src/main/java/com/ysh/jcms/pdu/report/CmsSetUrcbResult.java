...
public class CmsSetUrcbResult extends CmsSequence {
    ...
    @CmsField(optional = true) public CmsServiceError resv;

    public CmsSetUrcbResult() {
        super(new InnerAnonymousSetURCBValuesErrorPDUResult());
    }

    public CmsSetUrcbResult error(int v) { this.error.value(v); setPresent("error", true); return this; }
    public CmsSetUrcbResult rptID(int v) { this.rptID.value(v); setPresent("rptID", true); return this; }
    public CmsSetUrcbResult rptEna(int v) { this.rptEna.value(v); setPresent("rptEna", true); return this; }
    public CmsSetUrcbResult datSet(int v) { this.datSet.value(v); setPresent("datSet", true); return this; }
    public CmsSetUrcbResult optFlds(int v) { this.optFlds.value(v); setPresent("optFlds", true); return this; }
    public CmsSetUrcbResult bufTm(int v) { this.bufTm.value(v); setPresent("bufTm", true); return this; }
    public CmsSetUrcbResult trgOps(int v) { this.trgOps.value(v); setPresent("trgOps", true); return this; }
    public CmsSetUrcbResult intgPd(int v) { this.intgPd.value(v); setPresent("intgPd", true); return this; }
    public CmsSetUrcbResult gi(int v) { this.gi.value(v); setPresent("gi", true); return this; }
    public CmsSetUrcbResult resv(int v) { this.resv.value(v); setPresent("resv", true); return this; }
    ...
    public CmsSetUrcbResult value(CmsSetUrcbResult v) {
        ...
        if (v.isPresent("resv")) { this.resv.value(v.resv.value()); setPresent("resv", true); }
        else { setPresent("resv", false); }
        return this;
    }
}
