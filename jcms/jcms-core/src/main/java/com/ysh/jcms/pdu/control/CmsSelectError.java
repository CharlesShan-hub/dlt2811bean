...
/**
 * Select-ErrorPDU ::= SEQUENCE { reference [0] IMPLICIT ObjectReference } — 8.11.1
 */
public class CmsSelectError extends CmsSequence {

    @CmsField public CmsObjectReference reference;

    public CmsSelectError() { super(new InnerSelectErrorPDU()); }

    public CmsSelectError reference(byte[] v) { this.reference.value(new String(v, StandardCharsets.UTF_8)); return this; }
