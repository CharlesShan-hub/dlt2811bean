...
public class CmsReportEntry extends CmsTypeOld {
    ...
    public CmsReportEntry timeOfEntryPresent(boolean v) {
        this.timeOfEntryPresent.value(v);
        return this;
    }
    ...
    public CmsReportEntry entryIdPresent(boolean v) {
    ...
    public CmsReportEntry entryId(String v) {
        this.entryIdPresent.value(v != null);
        if (v != null)
            this.entryId.value(v);
        return this;
    }
    public CmsReportEntry entryData(CmsArray<CmsReportDataEntry> v) {
        this.entryData = v;
        return this;
    }
