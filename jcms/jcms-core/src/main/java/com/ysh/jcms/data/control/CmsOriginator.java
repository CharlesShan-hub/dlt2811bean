...
/**
 * Originator ::= SEQUENCE { orCat [0] INTEGER (0..8) → CmsOrCat, orIdent [1]
 * OCTET STRING (SIZE(0..64)) } — 7.5.2
 *
 * All-pointer container: [0] orCat → CmsOrCat* [8] orIdent → CmsUint8Array*
 */
public class CmsOriginator extends CmsType {
    ...
    public CmsOriginator orIdent(String v) {
        this.orIdent.value(v);
        return this;
    }
