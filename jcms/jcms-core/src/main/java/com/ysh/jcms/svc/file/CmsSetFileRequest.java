...
/**
 * SetFile-RequestPDU ::= SEQUENCE { reqId Int16U, filename [0] IMPLICIT
 * VisibleString255, startPosition [1] IMPLICIT INT32U, fileData [2] IMPLICIT
 * OCTET STRING, endOfFile [3] IMPLICIT BOOLEAN DEFAULT FALSE } — 8.12.2
 */
public class CmsSetFileRequest extends CmsTypeOld {
    ...
    public CmsSetFileRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsSetFileRequest fileData(String v) {
        this.fileData.value(v);
        return this;
    }
