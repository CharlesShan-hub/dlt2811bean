...
public class CmsGetRpcMethodDirectoryRequest extends CmsType {
    ...
    public CmsGetRpcMethodDirectoryRequest() { super(Codec.GET_RPC_METHOD_DIRECTORY_REQUEST);
    ...
    public CmsGetRpcMethodDirectoryRequest interfaceName(String v) { this.interfaceName.value(v); return this; }
