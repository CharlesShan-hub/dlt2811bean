...
/**
 * GetFileDirectory-RequestPDU ::= SEQUENCE { reqId Int16U, pathName [0]
 * IMPLICIT VisibleString255, startTime [1] IMPLICIT TimeStamp OPTIONAL,
...
public class CmsGetFileDirectoryRequest extends CmsTypeOld {
    ...
    public CmsGetFileDirectoryRequest() {
        super(Codec.GET_FILE_DIRECTORY_REQUEST);
    ...
    public CmsGetFileDirectoryRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsGetFileDirectoryRequest startTimePresent(boolean v) {
    ...
    public CmsGetFileDirectoryRequest stopTimePresent(boolean v) {
    ...
    public CmsGetFileDirectoryRequest fileAfterPresent(boolean v) {
        this.fileAfterPresent.value(v);
        return this;
    }
    public CmsGetFileDirectoryRequest fileAfter(byte[] v) {
        this.fileAfterPresent.value(v != null && v.length > 0);
        if (v != null)
            this.fileAfter.value(v);
        return this;
    }
    public CmsGetFileDirectoryRequest fileAfter(String v) {
        this.fileAfterPresent.value(v != null);
        if (v != null)
            this.fileAfter.value(v);
        return this;
    }
