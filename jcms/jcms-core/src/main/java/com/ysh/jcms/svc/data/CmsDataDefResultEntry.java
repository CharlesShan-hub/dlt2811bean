...
/**
 * DataDefResultEntry ::= SEQUENCE { cdcType [0] IMPLICIT VisibleString
 * OPTIONAL, definition [1] IMPLICIT DataDefinition }
 *
 * Used by GetDataDefinition Response (SEQUENCE OF DataDefResultEntry).
 */
public class CmsDataDefResultEntry extends CmsTypeOld {
    ...
    public CmsDataDefResultEntry cdcTypePresent(boolean v) {
        this.cdcTypePresent.value(v);
        return this;
    }
    public CmsDataDefResultEntry cdcType(byte[] v) {
