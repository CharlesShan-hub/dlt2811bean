...
public class CmsTimeActivatedOperateError extends CmsSequence {
    ...
    public CmsTimeActivatedOperateError() { super(new InnerTimeActivatedOperateErrorPDU()); }

    public CmsTimeActivatedOperateError reference(byte[] v) { this.reference.value(new String(v, StandardCharsets.UTF_8)); return this; }
    public CmsTimeActivatedOperateError reference(String v) { this.reference.value(v); return this; }
    public CmsTimeActivatedOperateError ctlVal(CmsData v) { this.ctlVal.value(v); return this; }
    public CmsTimeActivatedOperateError operTm(CmsUtcTime v) { this.operTm.value(v); return this; }
    public CmsTimeActivatedOperateError origin(CmsOriginator v) { this.origin.value(v); return this; }
    public CmsTimeActivatedOperateError ctlNum(int v) { this.ctlNum.value(v); return this; }
    public CmsTimeActivatedOperateError t(CmsUtcTime v) { this.t.value(v); return this; }
    public CmsTimeActivatedOperateError test(boolean v) { this.test.value(v); return this; }
    public CmsTimeActivatedOperateError check(CmsCheck v) { this.check.value(v); return this; }
