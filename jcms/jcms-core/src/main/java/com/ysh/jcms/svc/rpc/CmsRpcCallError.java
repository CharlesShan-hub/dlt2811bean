...
public class CmsRpcCallError extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeRpcCallError(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeRpcCallError(nativePtr, data); read(); }
}