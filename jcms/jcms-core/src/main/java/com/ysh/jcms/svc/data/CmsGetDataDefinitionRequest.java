...
public class CmsGetDataDefinitionRequest extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeGetDataDefinitionRequest(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeGetDataDefinitionRequest(nativePtr, data); read(); }
}