...
/**
 * QueryLogByTime-RequestPDU ::= SEQUENCE { reqId Int16U, logReference [0]
 * IMPLICIT ObjectReference, startTime [1] IMPLICIT EntryTime OPTIONAL, stopTime
...
public class CmsQueryLogByTimeRequest extends CmsType {
    ...
    public CmsQueryLogByTimeRequest() {
        super(Codec.QUERY_LOG_BY_TIME_REQUEST);
    ...
    public CmsQueryLogByTimeRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsQueryLogByTimeRequest startTimePresent(boolean v) {
        this.startTimePresent.value(v);
        return this;
    }
    ...
    public CmsQueryLogByTimeRequest stopTimePresent(boolean v) {
        this.stopTimePresent.value(v);
        return this;
    }
    ...
    public CmsQueryLogByTimeRequest entryAfterPresent(boolean v) {
        this.entryAfterPresent.value(v);
        return this;
    }
    public CmsQueryLogByTimeRequest entryAfter(byte[] v) {
        this.entryAfterPresent.value(v != null && v.length > 0);
        if (v != null)
            this.entryAfter.value(v);
        return this;
    }
    public CmsQueryLogByTimeRequest entryAfter(String v) {
        this.entryAfterPresent.value(v != null);
        if (v != null)
            this.entryAfter.value(v);
        return this;
    }
