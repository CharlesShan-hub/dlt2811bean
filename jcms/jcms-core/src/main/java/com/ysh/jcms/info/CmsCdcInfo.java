...
public enum CmsCdcInfo {
    ...
    GOOSE  ("GOOSE",  "GOOSE Control Block",       "GOOSE控制块",     "Generic Object Oriented Substation Event Control Block"),
    GSSE   ("GSSE",   "GSSE Control Block",        "GSSE控制块",      "Generic Substation State Event Control Block"),
