...
/**
 * SetLCBResult ::= SEQUENCE { error [0] IMPLICIT ServiceError OPTIONAL, logEna
 * [1] IMPLICIT ServiceError OPTIONAL, datSet [2] IMPLICIT ServiceError
 * OPTIONAL, trgOps [3] IMPLICIT ServiceError OPTIONAL, intgPd [4] IMPLICIT
 * ServiceError OPTIONAL, logRef [5] IMPLICIT ServiceError OPTIONAL, optFlds [6]
 * IMPLICIT ServiceError OPTIONAL, bufTm [7] IMPLICIT ServiceError OPTIONAL } —
 * 8.8.3
 *
...
public class CmsSetLcbResult extends CmsTypeOld {
    ...
    public CmsSetLcbResult errorPresent(boolean v) {
        this.errorPresent.value(v);
        return this;
    }
    public CmsSetLcbResult error(int v) {
        this.error.value(v);
        return this;
    }
    public CmsSetLcbResult logEnaErrPresent(boolean v) {
        this.logEnaErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult logEnaErr(int v) {
        this.logEnaErr.value(v);
        return this;
    }
    public CmsSetLcbResult datSetErrPresent(boolean v) {
        this.datSetErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult datSetErr(int v) {
        this.datSetErr.value(v);
        return this;
    }
    public CmsSetLcbResult trgOpsErrPresent(boolean v) {
        this.trgOpsErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult trgOpsErr(int v) {
        this.trgOpsErr.value(v);
        return this;
    }
    public CmsSetLcbResult intgPdErrPresent(boolean v) {
        this.intgPdErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult intgPdErr(int v) {
        this.intgPdErr.value(v);
        return this;
    }
    public CmsSetLcbResult logRefErrPresent(boolean v) {
        this.logRefErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult logRefErr(int v) {
        this.logRefErr.value(v);
        return this;
    }
    public CmsSetLcbResult optFldsErrPresent(boolean v) {
        this.optFldsErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult optFldsErr(int v) {
        this.optFldsErr.value(v);
        return this;
    }
    public CmsSetLcbResult bufTmErrPresent(boolean v) {
        this.bufTmErrPresent.value(v);
        return this;
    }
    public CmsSetLcbResult bufTmErr(int v) {
