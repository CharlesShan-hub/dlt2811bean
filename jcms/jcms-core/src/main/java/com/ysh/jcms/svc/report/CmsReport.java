...
/**
 * ReportPDU ::= SEQUENCE { reqId Int16U, rptID [0] IMPLICIT VisibleString129,
...
public class CmsReport extends CmsTypeOld {
    ...
    public CmsReport sqNumPresent(boolean v) {
        this.sqNumPresent.value(v);
        return this;
    }
    ...
    public CmsReport subSeqNumPresent(boolean v) {
        this.subSeqNumPresent.value(v);
        return this;
    }
    ...
    public CmsReport moreSegmentsFollowPresent(boolean v) {
        this.moreSegmentsFollowPresent.value(v);
        return this;
    }
    ...
    public CmsReport dataSetPresent(boolean v) {
        this.dataSetPresent.value(v);
        return this;
    }
    public CmsReport dataSet(byte[] v) {
        this.dataSetPresent.value(v != null && v.length > 0);
        if (v != null)
            this.dataSet.value(v);
        return this;
    }
    public CmsReport dataSet(String v) {
        this.dataSetPresent.value(v != null);
        if (v != null)
            this.dataSet.value(v);
        return this;
    }
    public CmsReport bufOvflPresent(boolean v) {
        this.bufOvflPresent.value(v);
        return this;
    }
    ...
    public CmsReport confRevPresent(boolean v) {
        this.confRevPresent.value(v);
        return this;
    }
