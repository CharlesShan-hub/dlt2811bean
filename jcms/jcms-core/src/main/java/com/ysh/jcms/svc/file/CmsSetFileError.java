...
public class CmsSetFileError extends CmsType {
    ...
    @Override public byte[] encode() { write(); return NativeBridge.encodeSetFileError(nativePtr); }
    @Override public void decode(byte[] data) { write(); NativeBridge.decodeSetFileError(nativePtr, data); read(); }
}