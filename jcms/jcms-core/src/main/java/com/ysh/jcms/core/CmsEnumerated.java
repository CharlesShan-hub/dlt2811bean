...
public class CmsEnumerated extends CmsType {
    ...
    public CmsEnumerated() { super(Codec.ENUMERATED);}
    public CmsEnumerated(int value) { super(Codec.ENUMERATED); this.value = value; write(); }

    /** Constructor with range validation. Subclasses pass (min, max, value). */
    public CmsEnumerated(int min, int max, int value) { super(Codec.ENUMERATED);
