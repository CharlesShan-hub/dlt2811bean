...
/**
 * GetDataSetValues-RequestPDU ::= SEQUENCE { reqId Int16U, datasetReference [0]
 * IMPLICIT ObjectReference, referenceAfter [1] IMPLICIT ObjectReference
 * OPTIONAL } — 8.5.1
 */
public class CmsGetDataSetValuesRequest extends CmsTypeOld {
    ...
    public CmsGetDataSetValuesRequest() {
        super(Codec.GET_DATA_SET_VALUES_REQUEST);
    ...
    public CmsGetDataSetValuesRequest reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsGetDataSetValuesRequest refAfterPresent(boolean v) {
        this.refAfterPresent.value(v);
        return this;
    }
    public CmsGetDataSetValuesRequest refAfter(byte[] v) {
        this.refAfterPresent.value(v != null && v.length > 0);
        if (v != null)
            this.refAfter.value(v);
        return this;
    }
    public CmsGetDataSetValuesRequest refAfter(String v) {
