 ...
 *
 * All-pointer container: [0] name → CmsObjectName* [8] fc_present → CmsBoolean*
 * [16] fc → CmsFC* [24] type → CmsDataDefinition*
 */
public class CmsDataDefinitionStructElem extends CmsType {
    ...
    public CmsDataDefinitionStructElem name(byte[] v) {
        this.name.value(v);
        return this;
    }
    ...
    public CmsDataDefinitionStructElem fc_present(boolean v) {
        this.fc_present.value(v);
        return this;
    }
    public CmsDataDefinitionStructElem fc(int v) {
        this.fc_present.value(true);
        this.fc.value(v);
        return this;
    }
