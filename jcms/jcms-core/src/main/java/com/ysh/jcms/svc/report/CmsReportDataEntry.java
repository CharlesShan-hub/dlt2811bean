...
public class CmsReportDataEntry extends CmsType {
    ...
    public CmsReportDataEntry refPresent(boolean v) {
        this.refPresent.value(v);
        return this;
    }
    ...
    public CmsReportDataEntry fcPresent(boolean v) {
    ...
    public CmsReportDataEntry reasonPresent(boolean v) {
        this.reasonPresent.value(v);
        return this;
    }
