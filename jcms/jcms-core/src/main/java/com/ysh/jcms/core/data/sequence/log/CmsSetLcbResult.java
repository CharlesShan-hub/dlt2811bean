...
public class CmsSetLcbResult extends CmsSequence {
    ...
    public CmsSetLcbResult() {
        super(new InnerAnonymousSetLCBValuesErrorPDUResult());
    }
    ...
    public CmsSetLcbResult logEna(int v) {
        this.logEna.value(v);
        setPresent("logEna", true);
        return this;
    }
    public CmsSetLcbResult datSet(int v) {
        this.datSet.value(v);
        setPresent("datSet", true);
        return this;
    }
    public CmsSetLcbResult trgOps(int v) {
        this.trgOps.value(v);
        setPresent("trgOps", true);
        return this;
    }
    public CmsSetLcbResult intgPd(int v) {
        this.intgPd.value(v);
        setPresent("intgPd", true);
        return this;
    }
    public CmsSetLcbResult logRef(int v) {
        this.logRef.value(v);
        setPresent("logRef", true);
        return this;
    }
    public CmsSetLcbResult optFlds(int v) {
        this.optFlds.value(v);
        setPresent("optFlds", true);
        return this;
    }
    public CmsSetLcbResult bufTm(int v) {
        this.bufTm.value(v);
