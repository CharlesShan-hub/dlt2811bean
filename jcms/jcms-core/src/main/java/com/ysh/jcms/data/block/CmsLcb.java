 ...
 *
 * OPTIONAL fields (optFlds, bufTm) use a CmsBoolean "present" flag before the
 * value.
 */
public class CmsLcb extends CmsType {
    ...
    public CmsLcb optFlds_present(boolean v) {
        this.optFlds_present.value(v);
        return this;
    }
    ...
    public CmsLcb bufTm_present(boolean v) {
        this.bufTm_present.value(v);
        return this;
    }
    ...
    public List<? extends CmsType> children() {
        return Arrays.asList(logEna, datSet, trgOps, intgPd, logRef, optFlds_present, optFlds, bufTm_present, bufTm);
    }
}
