...
/**
 * SendGOOSEMessage-PDU ::= SEQUENCE { reqId Int16U, goID [0] IMPLICIT
 * VisibleString129, datSet [1] IMPLICIT ObjectReference OPTIONAL, goRef [2]
 * IMPLICIT ObjectReference OPTIONAL, t [3] IMPLICIT TimeStamp, stNum [4]
 * IMPLICIT INT32U, sqNum [5] IMPLICIT INT32U, simulation [6] IMPLICIT BOOLEAN,
 * confRev [7] IMPLICIT INT32U, ndsCom [8] IMPLICIT BOOLEAN, data [9] IMPLICIT
 * SEQUENCE OF Data } — 8.9.1
 *
...
public class CmsSendGooseMessage extends CmsTypeOld {
    ...
    public CmsSendGooseMessage() {
        super(Codec.SEND_GOOSE_MESSAGE);
    ...
    public CmsSendGooseMessage reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsSendGooseMessage datSetPresent(boolean v) {
    ...
    public CmsSendGooseMessage goRefPresent(boolean v) {
        this.goRefPresent.value(v);
        return this;
    }
    public CmsSendGooseMessage goRef(byte[] v) {
        this.goRefPresent.value(v != null && v.length > 0);
        if (v != null)
            this.goRef.value(v);
        return this;
    }
    public CmsSendGooseMessage goRef(String v) {
        this.goRefPresent.value(v != null);
        if (v != null)
            this.goRef.value(v);
        return this;
    }
    ...
    public CmsSendGooseMessage data(CmsArray<CmsData> v) {
        this.data = v;
        return this;
    }
