...
public class CmsGetRpcInterfaceDefinitionRequest extends CmsSequence {
    ...
    public CmsGetRpcInterfaceDefinitionRequest interfaceName(byte[] v) { return interfaceName(new String(v)); }
    ...
    public CmsGetRpcInterfaceDefinitionRequest referenceAfter(byte[] v) { return referenceAfter(v != null ? new String(v) : null); }
}
