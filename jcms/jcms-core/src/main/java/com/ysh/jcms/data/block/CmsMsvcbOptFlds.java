...
/**
 * MsvcbOptFlds ::= BIT STRING (SIZE(5)) — 7.6.6 PER: align + 1 byte (5 bits)
 *
 * All-pointer container: [0] refresh_time [8] sample_rate [16] data_set_name
 * [24] security
 */
public class CmsMsvcbOptFlds extends CmsType {
    ...
    public CmsMsvcbOptFlds refresh_time(boolean v) {
        this.refresh_time.value(v);
        return this;
    }
    public CmsMsvcbOptFlds sample_rate(boolean v) {
        this.sample_rate.value(v);
        return this;
    }
    public CmsMsvcbOptFlds data_set_name(boolean v) {
        this.data_set_name.value(v);
        return this;
    }
    public CmsMsvcbOptFlds security(boolean v) {
        this.security.value(v);
        return this;
    }
