...
/**
 * GetGOOSEElementNumber-RequestPDU ::= SEQUENCE { reqId Int16U, gocbReference
 * [0] IMPLICIT ObjectReference, memberData [1] IMPLICIT SEQUENCE OF
 * GoRefFcEntry } — 8.9.3
 */
public class CmsGetGooseElementNumberRequest extends CmsTypeOld {
    ...
    public CmsGetGooseElementNumberRequest memberData(CmsArray<CmsGoRefFcEntry> v) {
        this.memberData = v;
        return this;
    }
