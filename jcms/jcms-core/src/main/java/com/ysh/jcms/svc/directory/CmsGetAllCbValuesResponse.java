 ...
 * 8.3.6
 */
public class CmsGetAllCbValuesResponse extends CmsTypeOld {
    ...
    public CmsGetAllCbValuesResponse() {
        super(Codec.GET_ALL_CB_VALUES_RESPONSE);
        this.reqId = new CmsReqId();
        this.cbValue = new CmsArray<>(CmsCbValueEntry.class);
        this.moreFollows = new CmsBoolean();
    }

    public CmsGetAllCbValuesResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    public CmsGetAllCbValuesResponse cbValue(CmsArray<CmsCbValueEntry> v) {
        this.cbValue = v;
        return this;
    }
