...
public class CmsGetAllDataDefinitionRequest extends CmsType {
    ...
    public CmsGetAllDataDefinitionRequest() { super(Codec.GET_ALL_DATA_DEFINITION_REQUEST);
    ...
    public CmsGetAllDataDefinitionRequest fc(int v) { this.fcPresent.value(true); this.fc.value(v); return this; }
