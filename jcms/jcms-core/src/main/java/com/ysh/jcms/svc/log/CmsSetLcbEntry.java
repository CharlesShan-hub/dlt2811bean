...
/**
 * SetLCBEntry ::= SEQUENCE { reference [0] IMPLICIT ObjectReference, logEna [1]
 * IMPLICIT BOOLEAN OPTIONAL, datSet [2] IMPLICIT ObjectReference OPTIONAL,
 * trgOps [3] IMPLICIT TriggerConditions OPTIONAL, intgPd [4] IMPLICIT INT32U
 * OPTIONAL, logRef [5] IMPLICIT ObjectReference OPTIONAL, optFlds [6] IMPLICIT
 * LCBOptFlds OPTIONAL, bufTm [7] IMPLICIT INT32U OPTIONAL } — 8.8.3
 *
...
public class CmsSetLcbEntry extends CmsTypeOld {
    ...
    public CmsSetLcbEntry logEnaPresent(boolean v) {
        this.logEnaPresent.value(v);
        return this;
    }
    ...
    public CmsSetLcbEntry datSetPresent(boolean v) {
    ...
    public CmsSetLcbEntry trgOpsPresent(boolean v) {
    ...
    public CmsSetLcbEntry intgPdPresent(boolean v) {
    ...
    public CmsSetLcbEntry logRefPresent(boolean v) {
        this.logRefPresent.value(v);
        return this;
    }
    public CmsSetLcbEntry logRef(byte[] v) {
        this.logRefPresent.value(v != null && v.length > 0);
        if (v != null)
            this.logRef.value(v);
        return this;
    }
    public CmsSetLcbEntry logRef(String v) {
        this.logRefPresent.value(v != null);
        if (v != null)
            this.logRef.value(v);
        return this;
    }
    public CmsSetLcbEntry optFldsPresent(boolean v) {
    ...
    public CmsSetLcbEntry bufTmPresent(boolean v) {
