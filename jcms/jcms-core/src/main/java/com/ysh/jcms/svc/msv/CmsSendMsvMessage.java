...
/**
 * SendMSVMessage-PDU ::= SEQUENCE { reqId Int16U, msvID [0] IMPLICIT
 * VisibleString129, datSet [1] IMPLICIT ObjectReference OPTIONAL, smpCnt [2]
 * IMPLICIT INT16U, confRev [3] IMPLICIT INT32U, refTm [4] IMPLICIT TimeStamp
 * OPTIONAL, smpSynch [5] IMPLICIT INT8U, smpRate [6] IMPLICIT INT16U OPTIONAL,
 * simulation [7] IMPLICIT BOOLEAN, sample [8] IMPLICIT SEQUENCE OF Data, smpMod
 * [9] IMPLICIT SmpMod OPTIONAL } — 8.10.1
 *
 * Unconfirmed service — no Response or Error PDU.
 */
public class CmsSendMsvMessage extends CmsTypeOld {
    ...
    public CmsSendMsvMessage reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    ...
    public CmsSendMsvMessage datSetPresent(boolean v) {
        this.datSetPresent.value(v);
        return this;
    }
    public CmsSendMsvMessage datSet(byte[] v) {
    ...
    public CmsSendMsvMessage refTmPresent(boolean v) {
        this.refTmPresent.value(v);
        return this;
    }
    ...
    public CmsSendMsvMessage smpRatePresent(boolean v) {
        this.smpRatePresent.value(v);
        return this;
    }
    ...
    public CmsSendMsvMessage sample(CmsArray<CmsData> v) {
        this.sample = v;
        return this;
    }
    public CmsSendMsvMessage smpModPresent(boolean v) {
        this.smpModPresent.value(v);
        return this;
    }
    ...
    public List<? extends CmsTypeOld> children() {
        return Arrays.asList(reqId, msvId, datSetPresent, datSet, smpCnt, confRev, refTmPresent, refTm, smpSynch, smpRatePresent, smpRate,
                simulation, sample, smpModPresent, smpMod);
    }
}
