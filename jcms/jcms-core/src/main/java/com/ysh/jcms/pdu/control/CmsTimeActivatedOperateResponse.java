...
public class CmsTimeActivatedOperateResponse extends CmsSequence {
    ...
    public CmsTimeActivatedOperateResponse() { super(new InnerTimeActivatedOperateResponsePDU()); }

    public CmsTimeActivatedOperateResponse reference(byte[] v) { this.reference.value(new String(v, StandardCharsets.UTF_8)); return this; }
    public CmsTimeActivatedOperateResponse reference(String v) { this.reference.value(v); return this; }
    public CmsTimeActivatedOperateResponse ctlVal(CmsData v) { this.ctlVal.value(v); return this; }
    public CmsTimeActivatedOperateResponse operTm(CmsUtcTime v) { this.operTm.value(v); return this; }
    public CmsTimeActivatedOperateResponse origin(CmsOriginator v) { this.origin.value(v); return this; }
