...
/**
 * SetMSVCBEntry ::= SEQUENCE { reference [0] IMPLICIT ObjectReference, svEna
 * [1] IMPLICIT BOOLEAN OPTIONAL, msvID [2] IMPLICIT VisibleString129 OPTIONAL,
 * datSet [3] IMPLICIT ObjectReference OPTIONAL, smpMod [5] IMPLICIT SmpMod
 * OPTIONAL, smpRate [6] IMPLICIT INT16U OPTIONAL, optFlds [7] IMPLICIT
 * MSVCBOptFlds OPTIONAL } — 8.10.3
 *
...
public class CmsSetMsvcbEntry extends CmsTypeOld {
    ...
    public CmsSetMsvcbEntry svEnaPresent(boolean v) {
        this.svEnaPresent.value(v);
        return this;
    }
    ...
    public CmsSetMsvcbEntry msvIdPresent(boolean v) {
        this.msvIdPresent.value(v);
        return this;
    }
    public CmsSetMsvcbEntry msvId(byte[] v) {
        this.msvIdPresent.value(v != null && v.length > 0);
        if (v != null)
            this.msvId.value(v);
        return this;
    }
    public CmsSetMsvcbEntry msvId(String v) {
        this.msvIdPresent.value(v != null);
        if (v != null)
            this.msvId.value(v);
        return this;
    }
    public CmsSetMsvcbEntry datSetPresent(boolean v) {
        this.datSetPresent.value(v);
        return this;
    }
    public CmsSetMsvcbEntry datSet(byte[] v) {
    ...
    public CmsSetMsvcbEntry smpModPresent(boolean v) {
    ...
    public CmsSetMsvcbEntry smpRatePresent(boolean v) {
    ...
    public CmsSetMsvcbEntry optFldsPresent(boolean v) {
