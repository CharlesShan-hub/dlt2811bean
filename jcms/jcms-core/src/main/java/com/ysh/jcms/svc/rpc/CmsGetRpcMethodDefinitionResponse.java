...
/**
 * GetRpcMethodDefinition-ResponsePDU ::= SEQUENCE { reqId Int16U, reference [0]
...
public class CmsGetRpcMethodDefinitionResponse extends CmsTypeOld {
    ...
    public CmsGetRpcMethodDefinitionResponse() {
        super(Codec.GET_RPC_METHOD_DEFINITION_RESPONSE);
        this.reqId = new CmsReqId();
        this.reference = new CmsArray<>(CmsRpcMethodDefChoice.class);
        this.moreFollows = new CmsBoolean();
    }

    public CmsGetRpcMethodDefinitionResponse reqId(int v) {
        this.reqId.value(v);
        return this;
    }
    public CmsGetRpcMethodDefinitionResponse reference(CmsArray<CmsRpcMethodDefChoice> v) {
        this.reference = v;
        return this;
    }
