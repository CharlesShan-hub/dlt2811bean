// Auto-generated by csasn1 v0.1.0 at 2026-07-31 00:52 UTC: GetDataValuesRequestPDUData
//
...
public class InnerGetDataValuesRequestPDUData extends InnerBase {
    ...
    public static InnerGetDataValuesRequestPDUData decode(byte[] data) {
        try {
            ...
            r._v.put("_", MAPPER.convertValue(_node.isArray() ? _node : _node.elements().next(), new com.fasterxml.jackson.core.type.TypeReference<java.util.List<InnerAnonymousGetDataValuesRequestPDUData>>() {}));
            return r;
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
