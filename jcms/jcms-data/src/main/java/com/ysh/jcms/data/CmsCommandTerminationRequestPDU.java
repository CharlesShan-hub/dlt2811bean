// Auto-generated. ASN.1 type: CommandTerminationRequestPDU
...
@Data
public class CmsCommandTerminationRequestPDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("CommandTerminationRequestPDU", enc,
    ...
    public static CmsCommandTerminationRequestPDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("CommandTerminationRequestPDU", enc, data), CmsCommandTerminationRequestPDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
