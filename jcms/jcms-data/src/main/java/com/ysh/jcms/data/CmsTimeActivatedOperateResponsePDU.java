// Auto-generated. ASN.1 type: TimeActivatedOperateResponsePDU
...
@Data
public class CmsTimeActivatedOperateResponsePDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("TimeActivatedOperateResponsePDU", enc,
    ...
    public static CmsTimeActivatedOperateResponsePDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("TimeActivatedOperateResponsePDU", enc, data), CmsTimeActivatedOperateResponsePDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
