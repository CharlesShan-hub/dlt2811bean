// Auto-generated. ASN.1 type: CancelErrorPDU
...
@Data
public class CmsCancelErrorPDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("CancelErrorPDU", enc,
    ...
    public static CmsCancelErrorPDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("CancelErrorPDU", enc, data), CmsCancelErrorPDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
