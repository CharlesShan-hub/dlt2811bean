// Auto-generated. ASN.1 type: TimeActivatedOperateRequestPDU
...
@Data
public class CmsTimeActivatedOperateRequestPDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("TimeActivatedOperateRequestPDU", enc,
    ...
    public static CmsTimeActivatedOperateRequestPDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("TimeActivatedOperateRequestPDU", enc, data), CmsTimeActivatedOperateRequestPDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
