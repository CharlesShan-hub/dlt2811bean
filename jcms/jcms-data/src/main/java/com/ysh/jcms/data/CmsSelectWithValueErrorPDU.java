// Auto-generated. ASN.1 type: SelectWithValueErrorPDU
...
@Data
public class CmsSelectWithValueErrorPDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("SelectWithValueErrorPDU", enc,
    ...
    public static CmsSelectWithValueErrorPDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("SelectWithValueErrorPDU", enc, data), CmsSelectWithValueErrorPDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
