// Auto-generated. ASN.1 type: GetAllCBValuesRequestPDUReference
...
@Data
public class CmsGetAllCBValuesRequestPDUReference extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("GetAllCBValuesRequestPDUReference", enc, MAPPER.writeValueAsString(this));
        } catch (Exception e) {
    ...
    public static CmsGetAllCBValuesRequestPDUReference decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("GetAllCBValuesRequestPDUReference", enc, data), CmsGetAllCBValuesRequestPDUReference.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
