// Auto-generated. ASN.1 type: SelectWithValueRequestPDU
...
@Data
public class CmsSelectWithValueRequestPDU extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("SelectWithValueRequestPDU", enc,
    ...
    public static CmsSelectWithValueRequestPDU decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("SelectWithValueRequestPDU", enc, data), CmsSelectWithValueRequestPDU.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
