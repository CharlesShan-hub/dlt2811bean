// Auto-generated. ASN.1 type: GetLogicalNodeDirectoryRequestPDUReference
...
@Data
public class CmsGetLogicalNodeDirectoryRequestPDUReference extends CmsBase {
    ...
    public byte[] encode(String enc) {
        try {
            return CmsNative.encode("GetLogicalNodeDirectoryRequestPDUReference", enc, MAPPER.writeValueAsString(this));
        } catch (Exception e) {
    ...
    public static CmsGetLogicalNodeDirectoryRequestPDUReference decode(String enc, byte[] data) {
        try {
            return MAPPER.readValue(CmsNative.decode("GetLogicalNodeDirectoryRequestPDUReference", enc, data), CmsGetLogicalNodeDirectoryRequestPDUReference.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
