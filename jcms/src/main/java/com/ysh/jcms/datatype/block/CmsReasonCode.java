...
public class CmsReasonCode extends CmsField {
    ...
    public CmsBoolean.ByValue application_trigger = new CmsBoolean.ByValue();
    ...
    public static class ByValue extends CmsReasonCode implements Structure.ByValue {}
}