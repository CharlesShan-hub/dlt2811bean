...
public class GetGooseElementNumberDao {
    ...
    public GetGooseElementNumberDao gocbReference(String v) { this.gocbReference = v; return this; }
    ...
    public List<GetGooseElementNumberClient.MemberSpec> members() { return members; }
}
