...
public class GetDataSetValuesConsole extends CommandHandler<GetDataSetValuesDao, GetDataSetValuesClient> {
    ...
    public GetDataSetValuesConsole() {
        ...
        Param p2 = Param.of("after", "", "referenceAfter", String.class, false);
