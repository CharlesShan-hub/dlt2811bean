...
public class SetUrcbValuesDao {
    ...
    public SetUrcbValuesDao ref(String v) { this.ref = v; return this; }
    public SetUrcbValuesDao rptId(String v) { this.rptId = v; return this; }
    public SetUrcbValuesDao rptEna(Boolean v) { this.rptEna = v; return this; }
    public SetUrcbValuesDao datSet(String v) { this.datSet = v; return this; }
    public SetUrcbValuesDao bufTm(Integer v) { this.bufTm = v; return this; }
    public SetUrcbValuesDao intgPd(Integer v) { this.intgPd = v; return this; }
    public SetUrcbValuesDao gi(Boolean v) { this.gi = v; return this; }
    public SetUrcbValuesDao resv(Boolean v) { this.resv = v; return this; }
    ...
    CmsSetUrcbValuesRequest toRequest(int reqId) {
        ...
        CmsSetUrcbEntry entry = new CmsSetUrcbEntry()
        ...
        if (resv != null) { entry.resvPresent(true); entry.resv(resv); }
