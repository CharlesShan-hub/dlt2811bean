...
import com.ysh.jcms.app.handler.control.selectWithValue.SelectWithValueConsole;
...
public class CmsClientConsole extends CmsConsole {
    ...
    private void registerClients() {
        ...
        registerClient(new SelectWithValueClient());
    ...
    protected void registerHandlers() {
        ...
        register(new SelectWithValueConsole());
