 ...
 *
 * <p>Two-tier value storage:
 * <ul>
 *   <li><b>editValues</b> — SE (Set Edit) buffer, written by SetEditSGValue,
 *       read by GetEditSGValue when fc=SE</li>
...
public class SgSessionState {
    ...
    public static class SgcState {
        ...
        /**
         * SE (Set Edit) buffer: ref -> encoded CmsData bytes.
         * Populated by SetEditSGValue (fc=SE).
         */
        private final ConcurrentMap<String, byte[]> editValues = new ConcurrentHashMap<>();
        /**
         * SG (Setting Group) committed values: ref -> encoded CmsData bytes.
         * Promoted from editValues by ConfirmEditSGValues.
         */
