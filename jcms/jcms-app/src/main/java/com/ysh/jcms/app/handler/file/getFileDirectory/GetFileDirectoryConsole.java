    ...
    public void execute(CmsConsole console, Map<String, String> args) throws Exception {
        ...
        if (jsonMode) {
            ...
            for (int i = 0; i < result.entries.size(); i++) {
                ...
                sb.append("{\"fileName\":\"").append(CmsFormatUtil.escapeJson(e.fileName))
                    .append("\",\"fileSize\":").append(e.fileSize)
                    .append(",\"lastModified\":").append(e.lastModified)
                    .append(",\"checkSum\":").append(e.checkSum)
