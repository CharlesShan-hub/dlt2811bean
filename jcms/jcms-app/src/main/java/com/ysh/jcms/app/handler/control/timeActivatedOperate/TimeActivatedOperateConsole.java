...
public class TimeActivatedOperateConsole extends CommandHandler<TimeActivatedOperateDao, TimeActivatedOperateClient> {
    ...
    public TimeActivatedOperateConsole() {
        ...
        Param p4 = Param.of("origin", "", "origin", String.class, false);
        param(p4, "操作源，0 本地 1 远程");
        Param p5 = Param.of("ctlNum", "", "ctlNum", String.class, false);
        param(p5, "控制序号");
        Param p6 = Param.of("t", "", "t", String.class, false);
        param(p6, "时间戳");
        Param p7 = Param.of("test", "", "test", String.class, false);
        param(p7, "测试标志");
        Param p8 = Param.of("check", "", "check", String.class, false);
