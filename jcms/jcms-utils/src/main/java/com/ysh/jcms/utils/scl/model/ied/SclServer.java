...
public class SclServer {
    ...
    public int setDataValue(String ref, String value, SclDataTypeTemplates templates) {
        return com.ysh.jcms.utils.scl.util.SclSetSetDataValueResolver.setDataValue(this, ref, value, templates);
    }

    public SclDataDefinitionEntry resolveDataDefinition(String ref, String fc, SclDataTypeTemplates templates) {
        return com.ysh.jcms.utils.scl.util.SclDataDefinitionResolver.resolveDataDefinition(this, ref, fc, templates);
    }

    public SclFCDA parseRefToFcda(String ref) {
        return com.ysh.jcms.utils.scl.util.SclDataSetResolver.parseRefToFcda(this, ref);
    }
}
