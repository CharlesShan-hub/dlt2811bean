...
import com.ysh.jcms.utils.scl.model.document.SclHeader;
import com.ysh.jcms.utils.scl.model.document.SclHitem;
...
public class SclReader {
        ...
        while (reader.hasNext()) {
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                if ("SCL".equals(tag)) {
                    ...
                    scl.setHeader(parseHeader(reader));
                } else if ("Substation".equals(tag)) {
                    scl.setSubstation(parseSubstation(reader));
                } else if ("Communication".equals(tag)) {
                    scl.setCommunication(parseCommunication(reader));
                } else if ("IED".equals(tag)) {
                    scl.addIed(parseIed(reader));
                } else if ("DataTypeTemplates".equals(tag)) {
                    scl.setDataTypeTemplates(parseDataTypeTemplates(reader));
                }
            }
        }
        return scl;
        ...
        while (reader.hasNext()) {
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                if ("Address".equals(tag)) {
                    parseAddressChildren(reader, cap::addAddress);
    ...
    private SclServices parseServices(XMLStreamReader reader) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                String tag = reader.getLocalName();
                if ("ReportSettings".equals(tag)) {
                    services.setReportSettings(parseReportSettings(reader));
                } else if ("GSESettings".equals(tag)) {
                    services.setGseSettings(parseGseSettings(reader));
                } else if ("ConfLNsFixPrefix".equals(tag)) {
                    services.setConfLNsFixPrefix(true);
                } else if ("ConfLNsFixLnInst".equals(tag)) {
                    services.setConfLNsFixLnInst(true);
                }
            } else if (event == XMLStreamConstants.END_ELEMENT) {
