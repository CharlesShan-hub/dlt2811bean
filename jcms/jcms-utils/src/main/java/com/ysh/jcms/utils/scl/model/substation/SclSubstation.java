...
public class SclSubstation {
    ...
    public SclSubstation addVoltageLevel(SclVoltageLevel voltageLevel) {
        voltageLevels.add(voltageLevel);
        return this;
    }
    public SclSubstation addLNode(SclLNode lNode) {
        lNodes.add(lNode);
        return this;
    }
    public SclSubstation addTransformer(SclPowerTransformer transformer) {
        transformers.add(transformer);
        return this;
    }
    public SclSubstation addGeneralEquipment(SclGeneralEquipment ge) {
        generalEquipments.add(ge);
        return this;
    }
    public SclSubstation addFunction(SclFunction function) {
