...
`,
  params: [
    { key: 'ref', label: 'BRCB 引用 ref', type: 'text', required: true, placeholder: 'LD/LN.brcbName，如 LD0/LLN0.brcbAlarm' },
    ...
    { key: 'trg-ops', label: '触发条件 trg-ops', type: 'number', required: false, placeholder: 'TriggerConditions 位掩码', inline: 'mask' },
    ...
    { key: 'entry-id', label: '条目 ID entry-id', type: 'text', required: false, placeholder: 'EntryID 8 字节', inline: 'extra' },
    { key: 'resv-tms', label: '保留时间 resv-tms', type: 'number', required: false, placeholder: 'INT16', inline: 'extra' },
    { key: 'rpt-ena', label: '报告使能 rpt-ena', type: 'switch', required: false, inline: 'cmd' },
    { key: 'gi', label: '总召唤 gi', type: 'switch', required: false, inline: 'cmd' },
    { key: 'purge-buf', label: '清空缓存 purge-buf', type: 'switch', required: false, inline: 'cmd' },
  ],
}