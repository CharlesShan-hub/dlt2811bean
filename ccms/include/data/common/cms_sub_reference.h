...
CMS_EXPORT int cms_sub_reference_encode(const void *ptr, uint8_t **out_buf, size_t *out_len);
CMS_EXPORT int cms_sub_reference_decode(void *ptr, const uint8_t *in_buf, int in_len);
