 ...
 * 结构复用 cms_uint8_array_t { value*, len }，len 表示 bit 数。
 */

typedef cms_uint8_array_t cms_coded_enum_t;
...
static inline int cms_coded_enum_encode(const void *ptr, uint8_t **out_buf, size_t *out_len) {
