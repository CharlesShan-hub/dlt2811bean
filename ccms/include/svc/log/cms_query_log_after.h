...
CMS_EXPORT int cms_query_log_after_request_encode(
    const cms_query_log_after_request_t *pdu,
    uint8_t **out_buf, size_t *out_len
);

CMS_EXPORT int cms_query_log_after_request_decode(
    cms_query_log_after_request_t *pdu,
    const uint8_t *in_buf, int in_len
);

CMS_EXPORT int cms_query_log_after_response_encode(
    const cms_query_log_after_response_t *pdu,
    uint8_t **out_buf, size_t *out_len
);

CMS_EXPORT int cms_query_log_after_response_decode(
    cms_query_log_after_response_t *pdu,
    const uint8_t *in_buf, int in_len
);

CMS_EXPORT int cms_query_log_after_error_encode(
    const cms_query_log_after_error_t *pdu,
    uint8_t **out_buf, size_t *out_len
);

CMS_EXPORT int cms_query_log_after_error_decode(
    cms_query_log_after_error_t *pdu,
    const uint8_t *in_buf, int in_len
);
