...
CMS_EXPORT int cms_operate_response_encode(const cms_operate_response_t *pdu, uint8_t **out_buf, size_t *out_len);
CMS_EXPORT int cms_operate_response_decode(cms_operate_response_t *pdu, const uint8_t *in_buf, int in_len);
CMS_EXPORT int cms_operate_error_encode(const cms_operate_error_t *pdu, uint8_t **out_buf, size_t *out_len);
