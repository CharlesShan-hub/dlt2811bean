...
CMS_EXPORT int cms_get_rpc_method_definition_request_encode(const cms_get_rpc_method_definition_request_t *pdu, uint8_t **out_buf, size_t *out_len);
...
CMS_EXPORT int cms_get_rpc_method_definition_response_encode(const cms_get_rpc_method_definition_response_t *pdu, uint8_t **out_buf, size_t *out_len);
...
CMS_EXPORT int cms_get_rpc_method_definition_error_encode(const cms_get_rpc_method_definition_error_t *pdu, uint8_t **out_buf, size_t *out_len);
