...
CMS_EXPORT int cms_negotiate_request_encode(const cms_negotiate_request_t *pdu, uint8_t *out_buf, int *out_len);
CMS_EXPORT int cms_negotiate_request_decode(cms_negotiate_request_t *pdu, const uint8_t *in_buf, int in_len);
CMS_EXPORT int cms_negotiate_response_encode(const cms_negotiate_response_t *pdu, uint8_t *out_buf, int *out_len);
CMS_EXPORT int cms_negotiate_response_decode(cms_negotiate_response_t *pdu, const uint8_t *in_buf, int in_len);
CMS_EXPORT int cms_negotiate_error_encode(const cms_negotiate_error_t *pdu, uint8_t *out_buf, int *out_len);
