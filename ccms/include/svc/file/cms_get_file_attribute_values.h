...
CMS_EXPORT int cms_get_file_attribute_values_request_encode(const cms_get_file_attribute_values_request_t *pdu, uint8_t *out_buf, int *out_len);
...
CMS_EXPORT int cms_get_file_attribute_values_response_encode(const cms_get_file_attribute_values_response_t *pdu, uint8_t *out_buf, int *out_len);
...
CMS_EXPORT int cms_get_file_attribute_values_error_encode(const cms_get_file_attribute_values_error_t *pdu, uint8_t *out_buf, int *out_len);
