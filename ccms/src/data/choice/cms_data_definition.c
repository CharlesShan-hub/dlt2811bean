...
int cms_data_definition_encode_stream(per_stream_t *s, const void *ptr) {
    ...
    case CMS_DATA_DEFINITION_CHOICE_STRUCTURE: {
        ...
        for (int32_t i = 0; i < count; i++) {
            if (!arr || !arr->elements || !arr->elements[i])
                return CMS_ERR;
