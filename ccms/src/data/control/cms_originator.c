...
CMS_EXPORT int cms_originator_encode(cms_orcat_t oc, const uint8_t *oi, int oil, uint8_t *b, int *l)
...
CMS_EXPORT int cms_originator_decode(const uint8_t *b, int l, cms_orcat_t *oc, uint8_t *oi, int *oil)
