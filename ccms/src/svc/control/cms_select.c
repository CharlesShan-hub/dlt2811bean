...
int cms_select_response_encode(const cms_select_response_t *pdu, uint8_t *out_buf, int *out_len) {
...
int cms_select_error_encode(const cms_select_error_t *pdu, uint8_t *out_buf, int *out_len) {
    return cms_select_request_encode((const cms_select_request_t*)pdu, out_buf, out_len);
}
