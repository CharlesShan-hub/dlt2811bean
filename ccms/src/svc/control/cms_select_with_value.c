...
int cms_select_with_value_request_encode(const cms_select_with_value_request_t *pdu, uint8_t **out_buf,
                                         size_t *out_len) {
    per_stream_t s;
...
int cms_select_with_value_response_encode(const cms_select_with_value_response_t *pdu, uint8_t **out_buf,
                                          size_t *out_len) {
