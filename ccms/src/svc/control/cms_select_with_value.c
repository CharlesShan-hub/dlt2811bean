...
int cms_select_with_value_response_encode(const cms_select_with_value_response_t*pdu,uint8_t*out_buf,int*out_len){return cms_select_with_value_request_encode(pdu,out_buf,out_len);}
int cms_select_with_value_response_decode(cms_select_with_value_response_t*pdu,const uint8_t*in_buf,int in_len){return cms_select_with_value_request_decode(pdu,in_buf,in_len);}
