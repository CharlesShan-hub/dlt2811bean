...
int cms_cancel_request_encode(const cms_cancel_request_t *pdu, uint8_t **out_buf, size_t *out_len) {
    ...
    bool opt[1] = {(pdu->oper_tm_present && pdu->oper_tm_present->value) && pdu->oper_tm};
...
int cms_cancel_response_encode(const cms_cancel_response_t *pdu, uint8_t **out_buf, size_t *out_len) {
    return cms_cancel_request_encode((const cms_cancel_request_t *) pdu, out_buf, out_len);
}

int cms_cancel_response_decode(cms_cancel_response_t *pdu, const uint8_t *in_buf, int in_len) {
    return cms_cancel_request_decode((cms_cancel_request_t *) pdu, in_buf, in_len);
}
