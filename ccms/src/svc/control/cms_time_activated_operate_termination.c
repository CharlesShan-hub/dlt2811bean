#include "svc/control/cms_time_activated_operate_termination.h"
...
int cms_time_activated_operate_termination_encode(const cms_time_activated_operate_termination_t*pdu,uint8_t*out_buf,int*out_len){
...
int cms_time_activated_operate_termination_decode(cms_time_activated_operate_termination_t*pdu,const uint8_t*in_buf,int in_len){
