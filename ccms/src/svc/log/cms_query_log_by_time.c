...
int cms_query_log_by_time_request_encode(const cms_query_log_by_time_request_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
...
int cms_query_log_by_time_response_encode(const cms_query_log_by_time_response_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
