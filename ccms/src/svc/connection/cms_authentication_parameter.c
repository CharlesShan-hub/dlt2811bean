...
int cms_authentication_parameter_encode_stream(per_stream_t *s, const cms_authentication_parameter_t *param) {
    int err;
...
int cms_authentication_parameter_decode_stream(per_stream_t *s, void *ptr) {
...
int cms_authentication_parameter_encode(const cms_authentication_parameter_t *param, uint8_t *out_buf,
                                        size_t *out_len) {
    per_stream_t s;
    ...
    out_buf = (uint8_t *) per_stream_detach(&s, out_len);
    return CMS_OK;
}

int cms_authentication_parameter_decode(cms_authentication_parameter_t *param, const uint8_t *in_buf, int in_len) {
    per_stream_t s;
