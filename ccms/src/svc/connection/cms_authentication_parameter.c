    ...
    per_stream_t *s, const cms_authentication_parameter_t *param)
{
    ...
    utc.time_quality.leap_seconds_known.value    = 0;
    utc.time_quality.clock_failure.value          = 0;
    utc.time_quality.clock_not_synchronized.value = 0;
    utc.time_quality.precision.value = 31;
