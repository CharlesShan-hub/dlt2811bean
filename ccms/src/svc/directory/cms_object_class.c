...
int cms_object_class_encode(const cms_object_class_t *v, uint8_t **out_buf, size_t *out_len) {
    return cms_int32_encode(v, out_buf, out_len);
}

int cms_object_class_decode(cms_object_class_t *v, const uint8_t *in_buf, int in_len) {
