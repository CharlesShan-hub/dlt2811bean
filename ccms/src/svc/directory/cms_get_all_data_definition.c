...
int cms_get_all_data_definition_request_decode(
    cms_get_all_data_definition_request_t *pdu, const uint8_t *in_buf, int in_len)
{
    per_stream_t s;
...
int cms_get_all_data_definition_response_decode(
    cms_get_all_data_definition_response_t *pdu, const uint8_t *in_buf, int in_len)
{
    per_stream_t s;
    per_stream_init_read(&s, in_buf, (size_t)in_len);
    int err;
...
int cms_get_all_data_definition_error_decode(
    cms_get_all_data_definition_error_t *pdu, const uint8_t *in_buf, int in_len)
{
    per_stream_t s;
    per_stream_init_read(&s, in_buf, (size_t)in_len);
    int err;
