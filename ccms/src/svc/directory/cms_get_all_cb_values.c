...
int cms_get_all_cb_values_request_encode(const cms_get_all_cb_values_request_t *pdu, uint8_t **out_buf,
                                         size_t *out_len) {
    per_stream_t s;
...
int cms_get_all_cb_values_response_encode(const cms_get_all_cb_values_response_t *pdu, uint8_t **out_buf,
                                          size_t *out_len) {
    per_stream_t s;
