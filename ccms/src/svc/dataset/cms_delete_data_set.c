...
int cms_delete_data_set_request_encode(const cms_delete_data_set_request_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
...
int cms_delete_data_set_response_encode(const cms_delete_data_set_response_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
    per_error_t err_i = per_stream_init_write(&s, 64);
    if (err_i)
        return (int) err_i;
...
int cms_delete_data_set_error_encode(const cms_delete_data_set_error_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
