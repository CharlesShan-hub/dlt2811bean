...
int cms_delete_file_request_encode(const cms_delete_file_request_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
...
int cms_delete_file_response_encode(const cms_delete_file_response_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
...
int cms_delete_file_error_encode(const cms_delete_file_error_t *pdu, uint8_t **out_buf, size_t *out_len) {
    per_stream_t s;
    per_error_t err_init = per_stream_init_write(&s, 64);
    if (err_init) return (int)err_init;
    int err;
