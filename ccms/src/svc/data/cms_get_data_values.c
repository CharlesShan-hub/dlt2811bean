...
int cms_get_data_values_request_encode(const cms_get_data_values_request_t *pdu, uint8_t *out_buf, int *out_len) {
    per_stream_t s;
...
int cms_get_data_values_response_encode(const cms_get_data_values_response_t *pdu, uint8_t *out_buf, int *out_len) {
    per_stream_t s;
    per_stream_init_write(&s, out_buf, (size_t)*out_len);
    int err;
...
int cms_get_data_values_error_encode(const cms_get_data_values_error_t *pdu, uint8_t *out_buf, int *out_len) {
    per_stream_t s;
    per_stream_init_write(&s, out_buf, (size_t)*out_len);
    int err;
