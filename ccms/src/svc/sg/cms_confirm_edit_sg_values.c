...
int cms_confirm_edit_sg_values_request_decode(cms_confirm_edit_sg_values_request_t *pdu, const uint8_t *in_buf, int in_len) {
    per_stream_t s;
...
int cms_confirm_edit_sg_values_response_decode(cms_confirm_edit_sg_values_response_t *pdu, const uint8_t *in_buf, int in_len) {
    per_stream_t s;
    per_stream_init_read(&s, in_buf, (size_t)in_len);
...
int cms_confirm_edit_sg_values_error_decode(cms_confirm_edit_sg_values_error_t *pdu, const uint8_t *in_buf, int in_len) {
    per_stream_t s;
    per_stream_init_read(&s, in_buf, (size_t)in_len);
    int err;
