...
int cms_sgcb_value_choice_decode_stream(per_stream_t *s, void *ptr) {
    cms_sgcb_value_choice_t *v = (cms_sgcb_value_choice_t*)ptr;
    uint32_t sel;
    ...
    case CMS_SGCB_VALUE_CHOICE_VALUE:
        ...
        return cms_sgcb_decode_stream(s, v ? v->alt_value : NULL);
    default:
        return CMS_ERR;
    }
}
