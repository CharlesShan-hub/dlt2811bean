...
public final class PerInteger {
    ...
    // ==================== BOOLEAN (delegates to constrained int range=2) ====================

    /**
     * Encodes a boolean value as a single bit.
     * Equivalent to {@code encode(pos, value ? 1 : 0, 0, 1)}.
     *
     * @param pos   output stream
     * @param value boolean value
     */
    public static void encodeBoolean(PerOutputStream pos, boolean value) {
        pos.writeBit(value);
    }
     ...
     * @throws PerDecodeException if insufficient data
     */
    public static boolean decodeBoolean(PerInputStream pis) throws PerDecodeException {
        return pis.readBit();
    }
