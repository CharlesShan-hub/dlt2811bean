...
public class CmsBitString extends AbstractCmsScalar<byte[]> {
    ...
    public byte[] encode() {
        ...
        CmsFFIDatatypes.INSTANCE.cms_encode_BitString(value, value.length, buf, outLen);
    ...
    public static CmsBitString decode(byte[] data) {
        ...
        CmsFFIDatatypes.INSTANCE.cms_decode_BitString(data, data.length, valBuf, valLen);
