...
public class CmsBitString extends AbstractCmsScalar<CmsBitString, byte[]> {
    ...
    protected int ffiEncode(byte[] buf, IntByReference outLen) {
        return CmsFFIDatatypes.INSTANCE.cms_bit_string_encode(value, value.length, 65535, buf, outLen);
    }
    ...
    public static CmsBitString decode(byte[] data) {
        ...
        CmsFFIDatatypes.INSTANCE.cms_bit_string_decode(data, data.length, 65535, valBuf, valLen);
