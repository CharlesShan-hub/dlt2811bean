...
public final class CmsInteger {
    ...
    public byte[] encodeInt8() {
        ...
        CmsFFI.INSTANCE.cms_encode_Int8((byte) value, buf, outLen);
    ...
    public byte[] encodeInt8U() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int8U((short) value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public byte[] encodeInt16() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int16((short) value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public static CmsInteger decodeInt16(byte[] data) {
        IntByReference v = new IntByReference();
        CmsFFI.INSTANCE.cms_decode_Int16(data, data.length, v);
        return new CmsInteger(v.getValue());
    }
    ...
    public byte[] encodeInt16U() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int16U((int) value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public byte[] encodeInt32() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int32((int) value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public byte[] encodeInt32U() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int32U(value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public static CmsInteger decodeInt32U(byte[] data) {
        ...
        CmsFFI.INSTANCE.cms_decode_Int32U(data, data.length, v);
        return new CmsInteger(v.getValue());
    }
    ...
    public byte[] encodeInt64() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int64(value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public static CmsInteger decodeInt64(byte[] data) {
        LongByReference v = new LongByReference();
        CmsFFI.INSTANCE.cms_decode_Int64(data, data.length, v);
        return new CmsInteger(v.getValue());
    }
    ...
    public byte[] encodeInt64U() {
        byte[] buf = new byte[16];
        IntByReference outLen = new IntByReference(buf.length);
        CmsFFI.INSTANCE.cms_encode_Int64U(value, buf, outLen);
        byte[] result = new byte[outLen.getValue()];
        System.arraycopy(buf, 0, result, 0, result.length);
        return result;
    }
    ...
    public static CmsInteger decodeInt64U(byte[] data) {
        LongByReference v = new LongByReference();
        CmsFFI.INSTANCE.cms_decode_Int64U(data, data.length, v);
        return new CmsInteger(v.getValue());
    }
