...
public class CmsOctetString extends AbstractCmsScalar<byte[]> {
    ...
    public byte[] encode() {
        ...
        CmsFFIDatatypes.INSTANCE.cms_encode_OctetString(value, value.length, buf, outLen);
    ...
    public static CmsOctetString decode(byte[] data) {
        ...
        CmsFFIDatatypes.INSTANCE.cms_decode_OctetString(data, data.length, valBuf, valLen);
