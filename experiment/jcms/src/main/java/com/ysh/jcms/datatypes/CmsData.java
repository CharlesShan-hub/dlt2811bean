...
public final class CmsData {
    ...
    public byte[] encode() {
        ...
        CmsFFI.INSTANCE.cms_ffi_encode_Data(choice, intVal, floatVal, strVal, bytes, bytes.length, buf, outLen);
    ...
    public static CmsData decode(byte[] data) {
        ...
        CmsFFI.INSTANCE.cms_ffi_decode_Data(data, data.length, choice, intVal, floatVal, strBuf, strCap, bytesBuf, bytesCap);
