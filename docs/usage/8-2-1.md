...
```
请求: [FL:2][CC:0x01][SC:0x01][FL-hi][FL-lo][reqId:2][sapRef:N][(authParam:...)]
响应: [FL:2][CC:0x41][SC:0x01][FL-hi][FL-lo][reqId:2][associationId:N][result:1][(authParam:...)]
错误: [FL:2][CC:0x61][SC:0x01][FL-hi][FL-lo][reqId:2][serviceError:1]
```
...
cms> associate --ap C_B5041X/UNKNOWN
  ERR Associate rejected: INSTANCE_NOT_AVAILABLE (1)
```
